...
class TestAccounts(TestBase):
    ...
    def test_get_organizations(self):
        ...
        organizations1 = self.request("get", reverse("user_organization"), {}, None, 401)
        organizations1 = self.request("get", reverse("user_organization"), {}, token1, 200)
        self.assertEqual(len(organizations1), 1)
        self.assertEqual(organizations1[0]["slug"], "big-co")

        organizations2 = self.request("get", reverse("user_organization"), {}, token2, 200)
